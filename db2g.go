...
func (DB2G db2g) charToString(bytes []byte, column *column, conn *DmConnection) string {
	...
	return Packet.Dm_build_254(bytes, conn.serverEncoding, conn)
}
...
func (DB2G db2g) toBytes(bytes []byte, column *column, conn *DmConnection) ([]byte, error) {
	retBytes := Packet.Dm_build_152(bytes, 0, len(bytes))
	...
	case CLOB:
		...
		return Packet.Dm_build_217(str, conn.getServerEncoding(), conn), nil
	case BLOB:
...
func (DB2G db2g) toString(bytes []byte, column *column, conn *DmConnection) string {
	...
	case SMALLINT:
		return strconv.FormatInt(int64(Packet.Dm_build_225(bytes)), 10)
	case INT:
		return strconv.FormatInt(int64(Packet.Dm_build_228(bytes)), 10)
	case BIGINT:
		return strconv.FormatInt(int64(Packet.Dm_build_231(bytes)), 10)
	case REAL:
		return strconv.FormatFloat(float64(Packet.Dm_build_234(bytes)), 'f', -1, 32)
	case DOUBLE:
		return strconv.FormatFloat(float64(Packet.Dm_build_237(bytes)), 'f', -1, 64)
	case DECIMAL:
...
func (DB2G db2g) toBool(bytes []byte, column *column, conn *DmConnection) (bool, error) {
	...
	case SMALLINT:
		return Packet.Dm_build_98(bytes, 0) != 0, nil
	case INT:
		return Packet.Dm_build_103(bytes, 0) != 0, nil
	case BIGINT:
		return Packet.Dm_build_108(bytes, 0) != 0, nil
	case REAL:
		return Packet.Dm_build_113(bytes, 0) != 0, nil
	case DOUBLE:
		return Packet.Dm_build_117(bytes, 0) != 0, nil
	case DECIMAL:
...
func (DB2G db2g) toInt16(bytes []byte, column *column, conn *DmConnection) (int16, error) {
	...
	case SMALLINT:
		return Packet.Dm_build_98(bytes, 0), nil
	case INT:
...
func (DB2G db2g) toUInt16(bytes []byte, column *column, conn *DmConnection) (uint16, error) {
	...
	case SMALLINT:
		return uint16(Packet.Dm_build_98(bytes, 0)), nil
	case INT:
		tval := Packet.Dm_build_103(bytes, 0)
...
func (DB2G db2g) toInt32(bytes []byte, column *column, conn *DmConnection) (int32, error) {
	...
	case SMALLINT:
		return int32(Packet.Dm_build_98(bytes, 0)), nil
	case INT:
		return Packet.Dm_build_103(bytes, 0), nil
	case BIGINT:
		tval := Packet.Dm_build_108(bytes, 0)
...
func (DB2G db2g) toUInt32(bytes []byte, column *column, conn *DmConnection) (uint32, error) {
	...
	case SMALLINT:
		return uint32(Packet.Dm_build_98(bytes, 0)), nil
	case INT:
		return uint32(Packet.Dm_build_103(bytes, 0)), nil
	case BIGINT:
		tval := Packet.Dm_build_108(bytes, 0)
...
func (DB2G db2g) toInt64(bytes []byte, column *column, conn *DmConnection) (int64, error) {
	...
	case SMALLINT:
		return int64(Packet.Dm_build_225(bytes)), nil
	case INT:
		return int64(Packet.Dm_build_228(bytes)), nil
	case BIGINT:
		return int64(Packet.Dm_build_231(bytes)), nil
	case REAL:
		return int64(Packet.Dm_build_234(bytes)), nil
	case DOUBLE:
		return int64(Packet.Dm_build_237(bytes)), nil
...
func (DB2G db2g) toUInt64(bytes []byte, column *column, conn *DmConnection) (uint64, error) {
	...
	case SMALLINT:
		return uint64(Packet.Dm_build_225(bytes)), nil
	case INT:
		return uint64(Packet.Dm_build_228(bytes)), nil
	case BIGINT:
		return uint64(Packet.Dm_build_231(bytes)), nil
	case REAL:
		return uint64(Packet.Dm_build_234(bytes)), nil
	case DOUBLE:
		return uint64(Packet.Dm_build_237(bytes)), nil
...
func (DB2G db2g) toFloat32(bytes []byte, column *column, conn *DmConnection) (float32, error) {
	...
	case SMALLINT:
		return float32(Packet.Dm_build_98(bytes, 0)), nil
	case INT:
		return float32(Packet.Dm_build_103(bytes, 0)), nil
	case BIGINT:
		return float32(Packet.Dm_build_108(bytes, 0)), nil
	case REAL:
		return Packet.Dm_build_113(bytes, 0), nil
	case DOUBLE:
		dval := Packet.Dm_build_117(bytes, 0)
...
func (DB2G db2g) toFloat64(bytes []byte, column *column, conn *DmConnection) (float64, error) {
	...
	case SMALLINT:
		return float64(Packet.Dm_build_98(bytes, 0)), nil
	case INT:
		return float64(Packet.Dm_build_103(bytes, 0)), nil
	case BIGINT:
		return float64(Packet.Dm_build_108(bytes, 0)), nil
	case REAL:
		return float64(Packet.Dm_build_113(bytes, 0)), nil
	case DOUBLE:
		return Packet.Dm_build_117(bytes, 0), nil
	case DECIMAL:
		dval, err := DB2G.decToDecimal(bytes, int(column.prec), int(column.scale), conn.CompatibleOracle())
		if err != nil {
			return 0, err
...
func (DB2G db2g) toDmDecimal(value []byte, column *column, conn *DmConnection) (*DmDecimal, error) {
	...
	case SMALLINT:
		return NewDecimalFromInt64(int64(Packet.Dm_build_98(value, 0)))
	case INT:
		return NewDecimalFromInt64(int64(Packet.Dm_build_103(value, 0)))
	case BIGINT:
		return NewDecimalFromInt64(Packet.Dm_build_108(value, 0))
	case REAL:
		return NewDecimalFromFloat64(float64(Packet.Dm_build_113(value, 0)))
	case DOUBLE:
		return NewDecimalFromFloat64(Packet.Dm_build_117(value, 0))
	case DECIMAL:
...
func (DB2G db2g) toObject(bytes []byte, column *column, conn *DmConnection) (interface{}, error) {
	...
	case TINYINT:
		...
		return Packet.Dm_build_94(bytes, 0), nil
	case SMALLINT:
		return Packet.Dm_build_98(bytes, 0), nil
	case INT:
		return Packet.Dm_build_103(bytes, 0), nil
	case BIGINT:
		return Packet.Dm_build_108(bytes, 0), nil
	case DECIMAL:
